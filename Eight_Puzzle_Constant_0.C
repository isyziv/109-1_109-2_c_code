/* Heuristic is the constant 0 */
/*       Program for solving the 8-puzzle (Improved version).
	      (Heuristic used is the constant 0.)
...
void report_solution(node_type *node)
{
  if (node->parent != NULL)
  {
    ...
    {
    case up:
      printf("     Move a tile down.\n");
      break;
    case down:
      printf("     Move a tile up.  \n");
      break;
    case left:
      printf("     Move a tile right.\n");
      break;
    case right:
      printf("     Move a tile left.\n");
      break;
    }
  }
}
