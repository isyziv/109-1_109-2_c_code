/* This program prints the multiplication table for hexedecimal numerals in the following two formats:

Multiplication Table Format 1 (hexadecimal numerals):
...
Multiplication Table Format 2 (hexadecimal numerals):
...
int main(void) {
  ...
  printf("Multiplication Table Format 1 (hexadecimal numerals):\n\n");
  
  // Print the multiplication table of format 1. 
  ...
  printf("Multiplication Table Format 2 (hexadecimal numerals):\n\n");
  
  // Print the multiplication table of format 2. 
  for (i=1; i<=15; i++) {
    printf("  ");
    for (j=1; j<=15; j++) {
      printf("%X*%X=%2X  ", i, j, i*j);
      if (j==8) printf("\n  ");
    }
    printf("\n\n");
  }
